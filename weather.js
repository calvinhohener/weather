$(function() {
  var handleWeatherResponse = function(data) {
    ...
    var markup = "<p> The current weather is " + data.currently.summary + ", " + data.currently.apparentTemperature + " degrees" + ", " + data.currently.humidity + " humidity." +" The weather over the next three days is " + data.daily.summary ;
